...
public class XPathAxesDemo {
	...
	private static void navigate()
	{
		try
		{
			oBrowser.get("file:///D:/Excel/web automation/xpath_xpathaxes/WebTableHTML.html");
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
	...
	private static void basedOnTableFor5thRecordEnterSalary()
	{
		...
		//copy element=<input type="text" id="edit4">

		//*[@id="edit4"] =xpath

		//table[@id='tbl1']/descendant::tr[5]/td[6]/input=xpathaxes
	}
}
